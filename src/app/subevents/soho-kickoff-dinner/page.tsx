...
import { Calendar, Clock, MapPin, Users, Heart, Share2, Camera, ShoppingBag, Star, ArrowLeft } from 'lucide-react';
...
export default function SoHoKickoffDinnerPage() {
  ...
  const fetchSubEvent = async () => {
    try {
      const response = await fetch('/api/subevents/soho-kickoff-dinner');
      if (response.ok) {
  ...
  const handleRSVP = async () => {
    ...
    setRsvpLoading(true);
    try {
      const response = await fetch('/api/subevents/soho-kickoff-dinner/rsvp', {
        method: 'POST',
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-50 to-slate-100">
      ...
      <div className="relative h-96 overflow-hidden">
        ...
        <img
          src={subEvent.imageUrl || 'https://source.unsplash.com/random/1200x800?dinner,soho,design'}
          alt={subEvent.title}
          ...
          <div className="lg:col-span-2 space-y-8">
            ...
            <div className="bg-white rounded-2xl p-6 shadow-sm border border-gray-100">
              ...
              <p className="text-gray-700 leading-relaxed mb-6">
                {subEvent.description || "Join us for an exclusive kickoff dinner in the heart of SoHo, where design professionals, vendors, and enthusiasts gather to celebrate the start of NYCxDesign 2025. This intimate gathering features curated conversations, networking opportunities, and a preview of what's to come during the week-long festival."}
              </p>
            ...
            <div className="bg-white rounded-2xl p-6 shadow-sm border border-gray-100">
              <div className="flex items-center justify-between mb-6">
                <h2 className="text-2xl font-bold text-gray-900">Media Feed</h2>
              ...
              {subEvent.media && subEvent.media.length > 0 ? (
                ...
                <div className="text-center py-12">
                  ...
                  <p className="text-sm text-gray-400">Be the first to share photos from this event!</p>
                </div>
              )}
            </div>
          </div>
