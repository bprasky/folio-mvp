  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (!response.ok) {
        ...
        throw new Error(error.error || 'Failed to create festival');
      }
      ...
      alert(error instanceof Error ? error.message : 'Failed to create festival. Please try again.');
    } finally {
      setLoading(false);
    }
  };
    ...
    return (
      <div className="max-w-4xl mx-auto p-6">
        <div className="text-center py-12">
          ...
          <p className="text-gray-600">Admin access required to create festivals.</p>
        </div>
      </div>
    );
  }
  ...
  return (
    <div className="max-w-4xl mx-auto p-6">
      <div className="mb-8">
        ...
        <p className="text-gray-600">Create a festival that vendors can submit events for</p>
      </div>
